...
class DepressDefinitionPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return DepressDefinitionPageState();
  }
}

class DepressDefinitionPageState extends State<DepressDefinitionPage> {

  int currentPos = 0;
  List<String> listPaths = [
    "lib/assets/UnderstandingDepress1.png",
    "lib/assets/UnderstandingDepress2.png",
    "lib/assets/UnderstandingDepress3.png",
    "lib/assets/UnderstandingDepress4.png",
  ];
