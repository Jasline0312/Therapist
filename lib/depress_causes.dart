...
class DepressCausesPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return DepressCausesPageState();
  }
}

class DepressCausesPageState extends State<DepressCausesPage> {

  int currentPos = 0;
  List<String> listPaths = [
    "lib/assets/CauseDepress1.png",
    "lib/assets/CauseDepress2.png",
    "lib/assets/CauseDepress3.png",
    "lib/assets/CauseDepress4.png",
    "lib/assets/CauseDepress5.png",
  ];
