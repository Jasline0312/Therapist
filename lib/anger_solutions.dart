...
class AngerSolutionsPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return AngerSolutionsPageState();
  }
}

class AngerSolutionsPageState extends State<AngerSolutionsPage> {

  int currentPos = 0;
  List<String> listPaths = [
    "lib/assets/SolutionAngry1.png",
    "lib/assets/SolutionAngry2.png",
    "lib/assets/SolutionAngry3.png",
    "lib/assets/SolutionAngry4.png",
    "lib/assets/SolutionAngry5.png",
  ];
