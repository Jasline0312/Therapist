...
class StressDefinitionPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return StressDefinitionPageState();
  }
}

class StressDefinitionPageState extends State<StressDefinitionPage> {

  int currentPos = 0;
  List<String> listPaths = [
    "lib/assets/UnderstandingStress1.png",
    "lib/assets/UnderstandingStress2.png",
    "lib/assets/UnderstandingStress3.png",
    "lib/assets/UnderstandingStress4.png",
    "lib/assets/UnderstandingStress5.png",
    "lib/assets/UnderstandingStress6.png",
  ];
