...
class StressSolutionsPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return StressSolutionsPageState();
  }
}

class StressSolutionsPageState extends State<StressSolutionsPage> {

  int currentPos = 0;
  List<String> listPaths = [
    "lib/assets/SolutionStress1.png",
    "lib/assets/SolutionStress2.png",
    "lib/assets/SolutionStress3.png",
    "lib/assets/SolutionStress4.png",
    "lib/assets/SolutionStress5.png",
  ];
