...
class FearDefinitionPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return
      FearDefinitionPageState();
  }
}

class FearDefinitionPageState extends State<FearDefinitionPage> {

  int currentPos = 0;
  List<String> listPaths = [
    "lib/assets/UnderstandingFear1.png",
    "lib/assets/UnderstandingFear2.png",
    "lib/assets/UnderstandingFear3.png",
    "lib/assets/UnderstandingFear4.png",
    "lib/assets/UnderstandingFear5.png",
    "lib/assets/UnderstandingFear6.png",
    "lib/assets/UnderstandingFear7.png",
  ];
