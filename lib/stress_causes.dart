...
class StressCausesPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return StressCausesPageState();
  }
}

class StressCausesPageState extends State<StressCausesPage> {

  int currentPos = 0;
  List<String> listPaths = [
    "lib/assets/CauseStress1.png",
    "lib/assets/CauseStress2.png",
    "lib/assets/CauseStress3.png",
  ];
