...
class FearSolutionsPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return FearSolutionsPageState();
  }
}

class FearSolutionsPageState extends State<FearSolutionsPage> {

  int currentPos = 0;
  List<String> listPaths = [
    "lib/assets/SolutionFear1.png",
    "lib/assets/SolutionFear2.png",
  ];
