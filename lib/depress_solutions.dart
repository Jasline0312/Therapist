...
class DepressSolutionsPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return DepressSolutionsPageState();
  }
}

class DepressSolutionsPageState extends State<DepressSolutionsPage> {

  int currentPos = 0;
  List<String> listPaths = [
    "lib/assets/SolutionDepress1.png",
    "lib/assets/SolutionDepress2.png",
  ];
