...
class AngerCausesPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return AngerCausesPageState();
  }
}

class AngerCausesPageState extends State<AngerCausesPage> {

  int currentPos = 0;
  List<String> listPaths = [
    "lib/assets/CauseAngry1.png",
    "lib/assets//CauseAngry2.png",
    "lib/assets//CauseAngry3.png",
  ];
